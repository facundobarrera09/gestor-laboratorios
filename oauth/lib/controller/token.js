...
module.exports = function(req, res) {
    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            pieces = new Buffer.from(pieces[1], 'base64').toString('ascii').split(':', 2);
            if (!pieces || pieces.length !== 2)
        ...
        function(cb) {
            req.oauth2.model.client.checkGrantType(client, grantType, (err, correctGrant) => {
                if (!correctGrant && grantType !== 'refresh_token')
